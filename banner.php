                            ...
                            <div class="row box-product">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="product-block">
                                        <div class="image">
                                            <a class="img" href="Vinyl_Banner.php"><img alt="product info" src="images/products/vinyl-banners.jpg" title="Vinyl Banner"></a>
                                        </div>
                                        <div class="product-meta">
                                            <div class="name"><a href="Vinyl_Banner.php">Vinyl Banner</a></div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="product-block">
                                        <div class="image"> <a class="img" href="Adhesive_Banner.php"><img alt="product info" src="images/products/adhesive-banners.jpg" title="Adesive Banner"></a> </div>
                                        <div class="product-meta">
                                            <div class="name"><a href="Adhesive_Banner.php">Adhesive Banner</a></div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="product-block">
                                        <div class="image">
                                            <a class="img" href="Canvas_Banner.php"><img alt="Canvas Banner" src="images/products/standie.png" title="Canvas "></a> </div>
                                        <div class="product-meta">
                                            <div class="name"><a href="Canvas_Banner.php">Canvas Banner</a></div>
