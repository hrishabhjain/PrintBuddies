  ...
  <div class="row">
    <div class="col-md-3"> 
      ...
      <div class=" feature-box">
        <div class="feature-title"><i class="fa fa-phone circle-icon"></i>
          <h4>Call</h4>
        </div>
        <p> Schedule an appointment with our designers by calling/mailing us your requirement. Depending on your work our designers will visit you at your place.</p>
      </div>
    </div>
    <!-- end: feature box --> 
    <!-- feature box -->
    <div class="col-md-3">
      <div class=" feature-box">
        <div class="feature-title"><i class="fa fa-laptop circle-icon"></i>
          <h4>Get It Designed</h4>
        </div>
        <p>Get your thing designed when designer visits your place or by designing on mail. After that approve your design on mail.</p>
    ...
    <div class="col-md-3">
      <div class=" feature-box">
        ...
        <p>Post your job on our website so that printers can bid to take your work.</p>
      </div>
    </div>
    <!-- end: feature box --> 
    <!-- feature box -->
    <div class="col-md-3">
      <div class=" feature-box">
        ...
        <p> Get your order printed by the printer you find the most suitable to take your job. We'll deliver the product as soon as its printed. </p>
      </div>
    </div>
  </div>
</div>
